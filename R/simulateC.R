...
#' @param roomSize Integer. Room size to be tested.
...
simulateC <- function(k=2, roomSize=23, replicate=1e5) {
  .Call(`_GeneralBirthdayProblem_simulateC`, k=k, roomSize=roomSize, replicate=replicate)
}
